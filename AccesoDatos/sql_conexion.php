...
$array_central = array("SERVIDOR"=>"servidor", "Database"=>"LAKER_SA", "UID"=>"sa", "PWD"=>"Axoft1988", "CharacterSet" => "UTF-8");
...
//franquicias
$conexion_franquicias = array( "Database"=>"FRANQUICIAS_LAKERS", "UID"=>"sa", "PWD"=>"Axoft", "CharacterSet" => "UTF-8");
$cid_franquicias = sqlsrv_connect($servidor_lakerbis, $conexion_franquicias);

//tangonet buscar
$conexion_tangonet_bis_1 = array( "Database"=>"TangoNet_Bis_1", "UID"=>"sa", "PWD"=>"Axoft", "CharacterSet" => "UTF-8");
